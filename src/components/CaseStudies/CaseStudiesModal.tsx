...
const CaseStudiesModal: React.FC<Props> = ({
  ...
  return (
    ...
    >
      <div className="min-h-[90vh] flex flex-col md:flex-row items-center justify-between mt-10 md:mt-0">
        {activeCaseStudy && (
          <Image
            ...
            className="w-full md:w-[500px] h-[380px] rounded-[20px] object-cover"
          />
        )}
