...
const Awards = () => {
  return (
    <section className="relative w-screen px-[100px] py-[100px] overflow-x-hidden bg-primary-bg">
      <Reveal>
        <h2 className="font-semibold text-primary text-[70px] text-center font-league-spartan">
          Awards
        </h2>
      </Reveal>
      <Reveal delay={0.2}>
