...
const About = () => {
  return (
    <section
      id="about"
      className="relative w-screen overflow-x-hidden bg-primary-bg px-5 md:px-10 lg:px-[80px] pt-[100px] md:pt-[120px] lg:pt-[190px]"
    >
      ...
      <div
        className="hidden lg:flex flex-col justify-end absolute
          top-[22%] md:top-[24%] lg:top-[26%] 2xl:top-[24%] left-[80px] md:left-[100px] lg:left-[120px]
