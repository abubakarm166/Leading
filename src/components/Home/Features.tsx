...
const Features = () => {
  ...
  return (
    <section className="relative w-screen overflow-x-hidden bg-primary-bg px-5 sm:px-10 lg:px-[80px] pt-[40px] sm:pt-[50px] lg:pt-[60px] 2xl:pt-[40px]">
      ...
      <div className="relative mt-10 lg:mt-[70px] 2xl:mt-[50px] flex flex-col lg:flex-row items-center lg:items-center lg:ml-10 gap-6 lg:gap-8">
        <Reveal className="max-w-full lg:max-w-[60%] 2xl:max-w-[70%] order-1 lg:order-0">
          <div className="text-center lg:text-left">
            ...
            <p className="font-gilroy-regular mt-4 sm:mt-6 lg:mt-8 text-[16px] sm:text-[18px] max-w-full lg:max-w-[75%] mx-auto lg:mx-0 text-[#333] leading-relaxed">
              {activeItem.content}
            </p>
          </div>
        </Reveal>
        ...
        <Reveal delay={0.3} className="order-0 lg:order-1">
          <Image
            ...
            className="w-[280px] sm:w-[340px] lg:w-[320px] 2xl:w-[420px] h-auto object-contain"
          />
        </Reveal>
      </div>
    </section>
